...
def plot_weather_data(turnstile_weather):
    ...
    ##plot = ggplot(turnstile_weather, aes('ENTRIESn_hourly',''))+geom_point(color='red')+geom_line(color='red')+ggtitle('Total Entries per Unit')+xlab('UNIT')+ylab('ENTRIESn_hourly')
...
if __name__ == "__main__":
    input_filename = '../exercise_2/turnstile_data_master_with_weather.csv'
    image = "plot.png"
