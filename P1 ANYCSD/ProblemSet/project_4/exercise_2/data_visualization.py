...
def plot_weather_data(turnstile_weather):
    ...
    * Which stations have more exits or entries at different times of day
    ...
    plot = ggplot(turnstile_weather, aes('UNIT','ENTRIESn_hourly'))+geom_point(color='red')+geom_line(color='red')+ggtitle('Total Entries per Unit')+xlab('UNIT')+ylab('ENTRIESn_hourly')
    return plot
