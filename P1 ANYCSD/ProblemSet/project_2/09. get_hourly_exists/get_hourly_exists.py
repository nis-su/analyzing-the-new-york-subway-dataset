...
def get_hourly_exits(grp):
    ...
    EXITSn_hourly = df.EXITSn -  EXITSn_shifted 
    dict1 = {'EXITSn_hourly' : EXITSn_hourly }
    EXITSn_hourly_df = pd.DataFrame (dict1)
    EXITSn_hourly_df.fillna(0, inplace=True) 
    df = df.join(EXITSn_hourly_df)    #your code here
    return grp
