...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    # should help you.
    _data = pd.read_csv(hr_by_team_year_sf_la_csv)
    gg = ggplot(_data, aes('yearID','HR',color='teamID'))+geom_point()+geom_line()+ggtitle('Total HRs by year')+xlab('Year')+ylab('HR') 
    return gg
